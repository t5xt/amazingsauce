...
banPanelButton.addEventListener("click", () => {
  banCard.hidden = !banCard.hidden;
  if (!banCard.hidden) {
    banCard.scrollIntoView({ behavior: "smooth", block: "start" });
  }
});
