...
<head>
  ...
  <meta property="og:description" content="provided via lurki.ng">
  <meta property="og:site_name" content="lurki.ng">
  ${isVideo
    ? `<meta property="og:video" content="${escapeHtml(imageUrl)}">
  <meta property="og:video:type" content="${escapeHtml(fileType)}">
  <meta property="og:video:url" content="${escapeHtml(imageUrl)}">`
    : `<meta property="og:image:alt" content="${escapeHtml(title)}">
  <meta property="og:image" content="${escapeHtml(imageUrl)}">`}
  <meta property="og:url" content="${escapeHtml(url.href)}">
  <meta name="twitter:card" content="${isVideo ? "player" : "summary_large_image"}">
  <meta name="twitter:title" content="${escapeHtml(title)}">
  <meta name="twitter:description" content="provided via lurki.ng">
  ${isVideo
    ? `<meta name="twitter:player" content="${escapeHtml(imageUrl)}">`
...
<body>
  <main>
    ...
    ${isVideo
      ? `<video class="media-display" src="${escapeHtml(imageUrl)}" controls playsinline preload="metadata"></video>`
      : `<img class="media-display" src="${escapeHtml(imageUrl)}" alt="Shared media" type="${escapeHtml(fileType)}">`}
    <div class="actions">
      <a class="button" href="${escapeHtml(imageUrl)}">Open raw file</a>
    </div>
  </main>
</body>
</html>`;
